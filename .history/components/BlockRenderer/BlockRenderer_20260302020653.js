    ...
    switch (block.name) {
      ...
      case "core/gallery": {
        return (
          <Gallery
            ...
            cropImages={block.attributes.cropImages || false}
      ...
      case "core/column": {
        ...
        return (
          <Column
            key={block.id}
            width={block.attributes?.width} // Добавили ?
            textColor={
              theme[block.attributes?.textColor] || // Добавили ?
              block.attributes?.style?.color?.text
            }
            backgroundColor={
              theme[block.attributes?.backgroundColor] || // Добавили ?
              block.attributes?.style?.color?.background
            }
          >
            <BlockRenderer blocks={block.innerBlocks} />
